...
struct pms
{
    ...
    long randID;
    long polygonCount;
    vector<PMS_POLYGON> polygon;
    long sectorDivisions;
    long numSectors;
    vector<PMS_SECTOR> sector;
    long propCount;
    vector<PMS_PROP> prop;
    long sceneryCount;
    vector<PMS_SCENERY> scenery;
    long colliderCount;
    vector<PMS_COLLIDER> collider;
    long spawnpointCount;
    vector<PMS_SPAWNPOINT> spawnpoint;
    long waypointCount;
    vector<PMS_WAYPOINT> waypoint;
    float leftoffs;
    float rightoffs;
    float topoffs;
    float bottomoffs;
...
extern char Font1[100];
extern char Font2[100];
